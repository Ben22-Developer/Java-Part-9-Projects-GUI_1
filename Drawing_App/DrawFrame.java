...
public class DrawFrame extends JFrame {
    ...
    private void setButtons () {
        ...
        undo_button.setFont(new Font("Arial",Font.ITALIC,14));
        clear_button.setFont(new Font("Arial",Font.ITALIC,14));

        undo_button.setPreferredSize(new Dimension(75,35));
        clear_button.setPreferredSize(new Dimension(75,35));
    }
    ...
    private void setJPanels () {
        ...
        addJComponentsToJPanels(tab_panel, new JComponent[]{undo_button, clear_button, colors_box, shapes_box, is_filled_box}, window_width, 70);
        ...
        undo_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (counts > 0) {
                    ...
                    System.out.println("No drawn shape in the panel!");
                }
            }
        });
